#![rustfmt::skip]
#![allow(warnings)]
// Vendored from https://github.com/rust-lang/rust/blob/main/compiler/rustc_lexer/src/lib.rs
...
mod tests {
    ...
    #[test]
    fn test_naked_raw_str() { check_raw_str(r#""abc""#, Ok(0)); }

    #[test]
    fn test_raw_no_start() { check_raw_str(r##""abc"#"##, Ok(0)); }
    ...
    fn test_valid_shebang() {
        ...
        // Because shebangs are interpreted by the kernel, they must be on the first
        // line
        let input = "\n#!/bin/bash";
        assert_eq!(strip_shebang(input), None);
...
",
    ...
    fn nested_block_comments() {
        check_lexing("/* /* */ */'a'", FrontmatterAllowed::No, expect![[r#"
            Token { kind: BlockComment { doc_style: None, terminated: true }, len: 11 }
    ...
    #[test]
    fn lifetime() {
        check_lexing("'abc", FrontmatterAllowed::No, expect![[r#"
